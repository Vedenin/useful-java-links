...
2.  [Processing](https://github.com/processing/processing) Исходный код для Processing Development Environment (PDE) — программному языку для обработки видео и графики. Лицензия: [GNU 2](https://en.wikipedia.org/wiki/GNU_General_Public_License), рейтинг github'а - 1896. ![Не соместимая с закрытым ПО лицензия](https://raw.githubusercontent.com/Vedenin/useful-java-links/master/link-rus/license.png)
