...
-  [III. Работа с данными](#iii-Работа-с-данными)
    - [1. Системы, для обработки данных (работа с грязными данными, анализ и т.п.)](#iii-Работа-с-данными)
    - [2. Большие данные (big data)](#iii-Работа-с-данными)
-  [IV. Машинное обучение, нейроные сети, естественный языки](#iii-Работа-с-данными)
    - [1. Машинное обучение и нейроные сети (Machine Learning)](#iii-Работа-с-данными)
    - [2. Работа с естественными языками (NLP)](#iii-Работа-с-данными)
-  [V. Интеграция](#iii-Работа-с-данными)
    - [1. Интеграция](#iii-Работа-с-данными)
    - [2. Парсеры (Parser) и  «веб-пауки»/краулеры (web-crawling)](#iii-Работа-с-данными)
    - [3. Работа с Json](#iii-Работа-с-данными)
    - [4. Интеграция с Api разных систем (соц. сетей и т.&nbsp;п.)](#iii-Работа-с-данными)
    - [5. Работа с биткойном](#iii-Работа-с-данными)
-  [VI. Работа с сетью](#iii-Работа-с-данными)
    - [1. Веб сервера и сервера приложений (web server &amp; application server)](#iii-Работа-с-данными)
    - [2. Сеть и сокеты](#iii-Работа-с-данными)
    - [3. Работа с сообщениями (message), очереди сообщений и прием и отправка сообщений](#iii-Работа-с-данными)
    - [4. Работа с http и ssh](#iii-Работа-с-данными)
    - [5. Работа с rest](#iii-Работа-с-данными)
-  [VII. Инструменты для упрощения разработки](#iii-Работа-с-данными)
    - [1. IDE](#iii-Работа-с-данными)
    - [2. Инструменты и библиотеки для сборки, конфигурирования и развертывания Java приложений](#iii-Работа-с-данными)
    - [3. Производительность](#iii-Работа-с-данными)
    - [4. Генерация кода](#iii-Работа-с-данными)
    - [5. Анализ исходного кода](#iii-Работа-с-данными)
    - [6. Прочее](#iii-Работа-с-данными)
-  [IIX. Облака](#iii-Работа-с-данными)
    - [1. Системы на Java, работающие с облаками](#iii-Работа-с-данными)
-  [IX. Тестирование](#iii-Работа-с-данными)
    - [1. Тестирование](#iii-Работа-с-данными)
-  [X. Другие языки программирования, написанные на Java](#iii-Работа-с-данными)
    - [1. Языки программирования, написанные на Java](#iii-Работа-с-данными)
    - [2. Утилиты для других языков программирования, написанные на Java](#iii-Работа-с-данными)
    - [3. javascript](#iii-Работа-с-данными)
...
10.  [Cucumber jvm](https://github.com/cucumber/cucumber-jvm) Портирование Cucumber фреймворка для JVM. Лицензия: [MIT](https://ru.wikipedia.org/wiki/%D0%9B%D0%B8%D1%86%D0%B5%D0%BD%D0%B7%D0%B8%D1%8F_MIT) , рейтинг - 1047.
11.  [Rootbeer1](https://github.com/pcpratts/rootbeer1) Rootbeer GPU Compiler — программирование с использованием GPU на Java. Лицензия: [MIT](https://ru.wikipedia.org/wiki/%D0%9B%D0%B8%D1%86%D0%B5%D0%BD%D0%B7%D0%B8%D1%8F_MIT) , рейтинг - 972.
12.  [Oblac Jodd](https://github.com/oblac/jodd) Jodd это набор Java инструментов и микро фреймворк, компактный, но мощный. Jodd = tools + ioc + mvc + db + aop + tx + json + html < 1.5 Mb. Лицензия: [BSD 2](https://en.wikipedia.org/wiki/BSD_licenses#2-clause_license_.28.22Simplified_BSD_License.22_or_.22FreeBSD_License.22.29), рейтинг - 912.
13.  [Reactive streams jvm](https://github.com/reactive-streams/reactive-streams-jvm) Reactive Streams спецификация для JVM — предлагает стандарты для асинхронной потоковой обработки с отсутствие проблем с блокировками . Лицензия: [Public Domain (CC0)](http://creativecommons.org/publicdomain/zero/1.0/ ), рейтинг - 769.
14.  [Storm contrib](https://github.com/nathanmarz/storm-contrib) storm-contrib это свободный репозиторий с модулями, использующими Storm. Они включают разные spouts/bolts для интеграции с другими системами (Redis, Kafka, MongoDB, etc), и код для решений типовых задач Storm разработчиков.. Лицензия: [Eclipse Public 1.0](https://www.eclipse.org/legal/epl-v10.html), рейтинг - 504.
15.  [Spring projects Spring batch](https://github.com/spring-projects/spring-batch) Spring Batch это легковесный, всеобъемлющий фреймворк, предназначенный для разработки надежных приложений, работающих по расписанию (batch applications), жизненно важных для ежедневных операций корпоративных систем.. Лицензия: [Apache 2](https://ru.wikipedia.org/wiki/%D0%9B%D0%B8%D1%86%D0%B5%D0%BD%D0%B7%D0%B8%D1%8F_Apache) , рейтинг - 448.
...
3.  [Java Native Access](https://github.com/twall/jna) Java Native Access — система доступа к нативному API. Лицензия: LGPL 2.1/[Apache 2](https://ru.wikipedia.org/wiki/%D0%9B%D0%B8%D1%86%D0%B5%D0%BD%D0%B7%D0%B8%D1%8F_Apache) , рейтинг - 1750.
4.  [Tobie ua-parser](https://github.com/tobie/ua-parser) много языковой портирование парсера параметра user agent браузером. Лицензия: [Apache 2](https://ru.wikipedia.org/wiki/%D0%9B%D0%B8%D1%86%D0%B5%D0%BD%D0%B7%D0%B8%D1%8F_Apache)/[MIT](https://ru.wikipedia.org/wiki/%D0%9B%D0%B8%D1%86%D0%B5%D0%BD%D0%B7%D0%B8%D1%8F_MIT)/Perl, рейтинг - 1497.
5.  [Typesafehub config](https://github.com/typesafehub/config) библиотека для работы с разными типами конфигурационных файлов для JVM языков. Лицензия: [Apache 2](https://ru.wikipedia.org/wiki/%D0%9B%D0%B8%D1%86%D0%B5%D0%BD%D0%B7%D0%B8%D1%8F_Apache) , рейтинг - 1369.
6.  [Athou commafeed](https://github.com/Athou/commafeed) RSS reader, основанный Dropwizard и AngularJS, вдохновленный Google Reader . Лицензия: [Apache 2](https://ru.wikipedia.org/wiki/%D0%9B%D0%B8%D1%86%D0%B5%D0%BD%D0%B7%D0%B8%D1%8F_Apache) , рейтинг - 1226.
7.  [flyingsaucer](https://github.com/flyingsaucerproject/flyingsaucer) Flying Saucer это Java библиотека для использования XML или XHTML с использованием CSS 2.1 для генерации PDF, изображений или Swing panels.. Лицензия: [](https://en.wikipedia.org/wiki/GNU_General_Public_License)[GNU 2](https://en.wikipedia.org/wiki/GNU_General_Public_License).1, рейтинг - 504.
8.  [jcommander](https://github.com/cbeust/jcommander) Библиотека для парсинга параметров командных строк . Лицензия: [Apache 2](https://ru.wikipedia.org/wiki/%D0%9B%D0%B8%D1%86%D0%B5%D0%BD%D0%B7%D0%B8%D1%8F_Apache) , рейтинг - 445.
9.  [Smack](https://github.com/igniterealtime/Smack) Библиотека для создания XMPP клиента для JVMs и Android. Лицензия: [Apache 2](https://ru.wikipedia.org/wiki/%D0%9B%D0%B8%D1%86%D0%B5%D0%BD%D0%B7%D0%B8%D1%8F_Apache) , рейтинг - 426.
...
3.  [Gs collections](https://github.com/goldmansachs/gs-collections) Дополнение или замена стандартных Java коллекций и методов работающих с коллекциями. Лицензия: [Apache 2](https://ru.wikipedia.org/wiki/%D0%9B%D0%B8%D1%86%D0%B5%D0%BD%D0%B7%D0%B8%D1%8F_Apache) , рейтинг - 1201.
4.  [Puniverse Quasar](https://github.com/puniverse/quasar) Quasar это библиотека, добавляющая Fibers (высокопроизводительные легкие threads), Go-подобные channels и Erlang-подобные actors в JVM. Лицензия: Eclipse Public v1.0/[GNU Lesser 3](https://en.wikipedia.org/wiki/GNU_Lesser_General_Public_License), рейтинг - 1091.
5.  [Retrolambda](https://github.com/orfjackal/retrolambda) Поддержка лямба выражений из Java 8 в Java 7, 6 и 5\. Лицензия: [Apache 2](https://ru.wikipedia.org/wiki/%D0%9B%D0%B8%D1%86%D0%B5%D0%BD%D0%B7%D0%B8%D1%8F_Apache) , рейтинг - 1059.
6.  [Google Jimfs](https://github.com/google/jimfs) Jimfs это in-memory файловая система для Java 7 и выше, реализующая API абстрактной файловой системы, описанный в java.nio.file.. Лицензия: [Apache 2](https://ru.wikipedia.org/wiki/%D0%9B%D0%B8%D1%86%D0%B5%D0%BD%D0%B7%D0%B8%D1%8F_Apache) , рейтинг - 752.
7.  [Kilim](https://github.com/kilim/kilim) Легковесные потоки для Java с обменом сообщениями, nio, http и поддержкой расписания . Лицензия: [MIT](https://ru.wikipedia.org/wiki/%D0%9B%D0%B8%D1%86%D0%B5%D0%BD%D0%B7%D0%B8%D1%8F_MIT) , рейтинг - 517.
8.  [Functionaljava](https://github.com/functionaljava/functionaljava) Добавление функционального программирования в Java. Лицензия: [BSD 3](https://en.wikipedia.org/wiki/BSD_licenses#3-clause_license_.28.22Revised_BSD_License.22.2C_.22New_BSD_License.22.2C_or_.22Modified_BSD_License.22.29)  , рейтинг - 478.
9.  [OpenHFT Chronicle Queue](https://github.com/OpenHFT/Chronicle-Queue) Chronicle Queue работает так же как обычная Java очередь, однако каждое события сохраняется на жесткий диск . Лицензия: [GNU Lesser 3](https://en.wikipedia.org/wiki/GNU_Lesser_General_Public_License).0, рейтинг - 440.
...
12.  [Gargl](https://github.com/jodoglevy/gargl) - Generic API Recorder and Generator Lite (произносится "Gargle") - инструмент для автоматизации любого вебсайта, позволяет записывать любые запросы к сайту и превращать их в повторно используемый код на любом из языком программирования. Лицензия: [MIT](https://ru.wikipedia.org/wiki/%D0%9B%D0%B8%D1%86%D0%B5%D0%BD%D0%B7%D0%B8%D1%8F_MIT) , рейтинг - 462.
13.  [Handlebars.java](https://github.com/jknack/handlebars.java) это портирование Handlebars на Java, Handlebars система работы с шаблонами Mustache . Лицензия: [Apache 2](https://ru.wikipedia.org/wiki/%D0%9B%D0%B8%D1%86%D0%B5%D0%BD%D0%B7%D0%B8%D1%8F_Apache) , рейтинг - 451.
14.  [Liferay plugins](https://github.com/liferay/liferay-plugins) - набор плагинов для Liferay портала. Лицензия: [GNU Lesser 2.1](https://en.wikipedia.org/wiki/GNU_Lesser_General_Public_License), рейтинг - 444.
...
3.  [Activiti](https://github.com/Activiti/Activiti) это легковесная система управления бизнес процессами (Business Process Management (BPM) Platform ) . Лицензия: [Apache 2](https://ru.wikipedia.org/wiki/%D0%9B%D0%B8%D1%86%D0%B5%D0%BD%D0%B7%D0%B8%D1%8F_Apache) , рейтинг - 861.
4.  [Liferay Portal](https://github.com/liferay/liferay-portal) это свободная вебплатформа для построения бизнес приложений . Лицензия: [GNU Lesser 2.1](https://en.wikipedia.org/wiki/GNU_Lesser_General_Public_License), рейтинг - 739.
5.  [Broadleaf Commerce](https://github.com/BroadleafCommerce/BroadleafCommerce) - eCommerce фреймворк для крупных предприятий, основанный на Spring. Лицензия: [Apache 2](https://ru.wikipedia.org/wiki/%D0%9B%D0%B8%D1%86%D0%B5%D0%BD%D0%B7%D0%B8%D1%8F_Apache) , рейтинг - 518.
...
9.  [Hazelcast](https://github.com/hazelcast/hazelcast) Hazelcast свободное In-Memory хранилище. Лицензия: [Apache 2](https://ru.wikipedia.org/wiki/%D0%9B%D0%B8%D1%86%D0%B5%D0%BD%D0%B7%D0%B8%D1%8F_Apache) , рейтинг - 1167.
...
18.  [Leveldb](https://github.com/dain/leveldb) Портирование LevelDB на Java. LevelDB это быстрое key-value хранилище, разработанное Google. Лицензия: [Apache 2](https://ru.wikipedia.org/wiki/%D0%9B%D0%B8%D1%86%D0%B5%D0%BD%D0%B7%D0%B8%D1%8F_Apache) , рейтинг - 525.
19.  [Kairosdb](https://github.com/kairosdb/kairosdb) KairosDB — быстрая распределенная расширяемая time series база данных, написанная поверх Cassandra. . Лицензия: [Apache 2](https://ru.wikipedia.org/wiki/%D0%9B%D0%B8%D1%86%D0%B5%D0%BD%D0%B7%D0%B8%D1%8F_Apache) , рейтинг - 485.
20.  [Linkedin Sensei](https://github.com/linkedin/sensei) Распределенная поисковая база данных для работы в реальном времени. Лицензия: [Apache 2](https://ru.wikipedia.org/wiki/%D0%9B%D0%B8%D1%86%D0%B5%D0%BD%D0%B7%D0%B8%D1%8F_Apache) , рейтинг - 464.
...
22.  [Apache Drill](https://github.com/apache/drill) Зеркало Apache Drill. Без схемовый движок обработки SQL запросов для Hadoop, NoSQL и облачных сервисов. Лицензия: [Apache 2](https://ru.wikipedia.org/wiki/%D0%9B%D0%B8%D1%86%D0%B5%D0%BD%D0%B7%D0%B8%D1%8F_Apache) , рейтинг - 448.
...
6.  [Elasticsearch analysis ik](https://github.com/medcl/elasticsearch-analysis-ik) The IK Analysis плагин интеграции с Lucene IK анализаторов для elastic search, поддерживающий пользовательские словари. Лицензия: ?, рейтинг - 395.

### 3. Клиенты и драйверы баз данных - 21 проектов

1.  [Facebook Presto](https://github.com/facebook/presto) Библиотека для работы с распределенными SQL запросами к big data источникам (Cassandra, Hive, Kafka, MySQL, PostgreSQL и т.п.).  . Лицензия: [Apache 2](https://ru.wikipedia.org/wiki/%D0%9B%D0%B8%D1%86%D0%B5%D0%BD%D0%B7%D0%B8%D1%8F_Apache) , рейтинг - 3603.
2.  [Jedis](https://github.com/xetorthio/jedis) Невероятно маленький и эффективный Redis Java клиент. Лицензия: [MIT](https://ru.wikipedia.org/wiki/%D0%9B%D0%B8%D1%86%D0%B5%D0%BD%D0%B7%D0%B8%D1%8F_MIT) , рейтинг - 2495.
...
4.  [Mongodb Java Driver](https://github.com/mongodb/mongo-java-driver) Java клиент для MongoDB . Лицензия: [Apache 2](https://ru.wikipedia.org/wiki/%D0%9B%D0%B8%D1%86%D0%B5%D0%BD%D0%B7%D0%B8%D1%8F_Apache) / Creative Commons Attribution , рейтинг - 1276.
5.  [Yahoo Mysql_perf_analyzer](https://github.com/yahoo/mysql_perf_analyzer) Анализатор производительности MySQL. Лицензия: [Apache 2](https://ru.wikipedia.org/wiki/%D0%9B%D0%B8%D1%86%D0%B5%D0%BD%D0%B7%D0%B8%D1%8F_Apache) , рейтинг - 1082.
...
3.  [H2o](https://github.com/h2oai/h2o-2) = добавляет математические операции в Hadoop, h2o позволяет быстро вычислять статистику, машинное обучение и математические операции для bigdata . Лицензия: [Apache 2](https://ru.wikipedia.org/wiki/%D0%9B%D0%B8%D1%86%D0%B5%D0%BD%D0%B7%D0%B8%D1%8F_Apache) , рейтинг - 1725.
4.  [Cloudera Oryx](https://github.com/cloudera/oryx) это простая инфраструктура, обеспечивающая высоко нагруженную систему машинного обучения, анализа и выдачи прогнозов в режиме реального времени, работающая с Apache Hadoop, HTTP REST API и реализующая lambda architecture. . Лицензия: [Apache 2](https://ru.wikipedia.org/wiki/%D0%9B%D0%B8%D1%86%D0%B5%D0%BD%D0%B7%D0%B8%D1%8F_Apache) , рейтинг - 1142.
5.  [Twitter Ambrose](https://github.com/twitter/ambrose) это платформа для визуализации и мониторинга в реальном времени MapReduce data workflows. . Лицензия: [Apache 2](https://ru.wikipedia.org/wiki/%D0%9B%D0%B8%D1%86%D0%B5%D0%BD%D0%B7%D0%B8%D1%8F_Apache) , рейтинг - 1024.
6.  [Twitter Elephant bird](https://github.com/twitter/elephant-bird) - набор коллекций и алгоритмов от Twitter'а, для работы с Hadoop lzo, Apache Thrift, Hadoop, Pig, Hive, и HBase.. Лицензия: [Apache 2](https://ru.wikipedia.org/wiki/%D0%9B%D0%B8%D1%86%D0%B5%D0%BD%D0%B7%D0%B8%D1%8F_Apache) , рейтинг - 861.
...
15.  [Umongo](https://github.com/agirbal/umongo) - десктопное приложение для просмотра и управления вашим MongoDB кластером. Лицензия: [Apache 2](https://ru.wikipedia.org/wiki/%D0%9B%D0%B8%D1%86%D0%B5%D0%BD%D0%B7%D0%B8%D1%8F_Apache) , рейтинг - 495.
16.  [Apache Flink](https://github.com/apache/flink) - зеркало Apache Flink. Apache Flink это открытая платформа для обработки потоковых и пакетных данных. Лицензия: [Apache 2](https://ru.wikipedia.org/wiki/%D0%9B%D0%B8%D1%86%D0%B5%D0%BD%D0%B7%D0%B8%D1%8F_Apache) , рейтинг - 475.
...
3.  [Apache Tomcat](https://github.com/apache/tomcat) - зеркало Apache Tomcat — открытый web сервер с поддержкой сервлетов, jsp и некоторых аспектов J2EE. Лицензия: [Apache 2](https://ru.wikipedia.org/wiki/%D0%9B%D0%B8%D1%86%D0%B5%D0%BD%D0%B7%D0%B8%D1%8F_Apache) , рейтинг - 531.
...
3.  [Grpc java](https://github.com/grpc/grpc-java) gRPC-Java это реализация RPC библиотеки и фреймворка на Java. Лицензия: [BSD 3](https://en.wikipedia.org/wiki/BSD_licenses#3-clause_license_.28.22Revised_BSD_License.22.2C_.22New_BSD_License.22.2C_or_.22Modified_BSD_License.22.29), рейтинг - 753.
4.  [Socket.io java client](https://github.com/Gottox/socket.io-java-client) Реализация Socket.IO клиента на Java. Лицензия: [MIT](https://ru.wikipedia.org/wiki/%D0%9B%D0%B8%D1%86%D0%B5%D0%BD%D0%B7%D0%B8%D1%8F_MIT) , рейтинг - 688.
...
3.  [Real logic Aeron](https://github.com/real-logic/Aeron) Эффективная и надежная система отправки и получения одноадресных и многоадресных сообщения по сети (Publisher, Subscriber, Event, Monitoring и т.п.).. Лицензия: [Apache 2](https://ru.wikipedia.org/wiki/%D0%9B%D0%B8%D1%86%D0%B5%D0%BD%D0%B7%D0%B8%D1%8F_Apache) , рейтинг - 1103.
4.  [Zeromq Jeromq](https://github.com/zeromq/jeromq) ZeroMQ — система для работы с распределенными сообщениями, очередями, подписками и т.д.. Лицензия: [GNU 3](https://en.wikipedia.org/wiki/GNU_General_Public_License), рейтинг - 834.
5.  [Metamorphosis](https://github.com/killme2008/Metamorphosis) Высокопроизводительная распределенная система обмена сообщениями . Лицензия: [Apache 2](https://ru.wikipedia.org/wiki/%D0%9B%D0%B8%D1%86%D0%B5%D0%BD%D0%B7%D0%B8%D1%8F_Apache) , рейтинг - 580.
...
3.  [Http request](https://github.com/kevinsawicki/http-request) Java библиотека для отправки различных HTTP Request и получения response. Лицензия:  [MIT](https://ru.wikipedia.org/wiki/%D0%9B%D0%B8%D1%86%D0%B5%D0%BD%D0%B7%D0%B8%D1%8F_MIT) . , рейтинг - 1477.
4.  [Nanohttpd](https://github.com/NanoHttpd/nanohttpd) Крошечный и простой embeddable HTTP сервер для Java.. Лицензия: [BSD 3](https://en.wikipedia.org/wiki/BSD_licenses#3-clause_license_.28.22Revised_BSD_License.22.2C_.22New_BSD_License.22.2C_or_.22Modified_BSD_License.22.29), рейтинг - 1184.
...
6.  [Apache Zookeeper](https://github.com/apache/zookeeper) Зеркало Apache Hadoop ZooKeeper — позволяет разрабатывать и поддерживать сервер, который позволяет очень надежную распределенную координации. . Лицензия: [Apache 2](https://ru.wikipedia.org/wiki/%D0%9B%D0%B8%D1%86%D0%B5%D0%BD%D0%B7%D0%B8%D1%8F_Apache) , рейтинг - 987.
7.  [Moco](https://github.com/dreamhead/moco) Простой HTTP Stub сервер, для простого тестирования интеграции. Лицензия: [MIT](https://ru.wikipedia.org/wiki/%D0%9B%D0%B8%D1%86%D0%B5%D0%BD%D0%B7%D0%B8%D1%8F_MIT) , рейтинг - 857.
8.  [Webbit](https://github.com/webbit/webbit) Webbit — событийно-ориентированный вебсокет и HTTP сервер. Лицензия: [BSD 3](https://en.wikipedia.org/wiki/BSD_licenses#3-clause_license_.28.22Revised_BSD_License.22.2C_.22New_BSD_License.22.2C_or_.22Modified_BSD_License.22.29), рейтинг - 648.
9.  [Mashape Unirest java](https://github.com/Mashape/unirest-java) Unirest in Java: Упрощенная и легковесная HTTP клиент библиотека.. Лицензия: [MIT](https://ru.wikipedia.org/wiki/%D0%9B%D0%B8%D1%86%D0%B5%D0%BD%D0%B7%D0%B8%D1%8F_MIT) , рейтинг - 537.
...
3.  [Gocd](https://github.com/gocd/gocd) Основной репозиторий для сборки Go программ . Лицензия: [Apache 2](https://ru.wikipedia.org/wiki/%D0%9B%D0%B8%D1%86%D0%B5%D0%BD%D0%B7%D0%B8%D1%8F_Apache) , рейтинг - 1602.
4.  [Groovy core](https://github.com/groovy/groovy-core) Язык программирования Groovy. Лицензия: [Apache 2](https://ru.wikipedia.org/wiki/%D0%9B%D0%B8%D1%86%D0%B5%D0%BD%D0%B7%D0%B8%D1%8F_Apache) , рейтинг - 1327.
5.  [Jphp compiler Jphp](https://github.com/jphp-compiler/jphp) Альтернативный вариант Zend PHP для JVM, такой же как JRuby и Jython но только для PHP. Лицензия: [Apache 2](https://ru.wikipedia.org/wiki/%D0%9B%D0%B8%D1%86%D0%B5%D0%BD%D0%B7%D0%B8%D1%8F_Apache) , рейтинг - 969.
...
3.  [KeyBox](https://github.com/skavanagh/KeyBox) это SSH вебконсоль, которая используется для административного доступа в систему. Лицензия: [Apache 2](https://ru.wikipedia.org/wiki/%D0%9B%D0%B8%D1%86%D0%B5%D0%BD%D0%B7%D0%B8%D1%8F_Apache) , рейтинг - 792.
4.  [OpenTripPlanner](https://github.com/opentripplanner/OpenTripPlanner) это свободный планировщик поездок, поддерживает открытые стандартные форматы файлов (GTFS и OpenStreetMap), также включает REST API для планирования путишествий, как и Javascript клиент . Лицензия: [Apache 2](https://ru.wikipedia.org/wiki/%D0%9B%D0%B8%D1%86%D0%B5%D0%BD%D0%B7%D0%B8%D1%8F_Apache) , рейтинг - 704.
5.  [Netflix Servo](https://github.com/Netflix/servo) обеспечивает простой интерфейс для получения и публикации параметров приложений Netflix . Лицензия: [Apache 2](https://ru.wikipedia.org/wiki/%D0%9B%D0%B8%D1%86%D0%B5%D0%BD%D0%B7%D0%B8%D1%8F_Apache) , рейтинг - 681.
6.  [Jitsi](https://github.com/jitsi/jitsi) программа, обеспечивающее текстовую, голосовую и видеосвязь с разными протоколами SIP, XMPP/Jabber, AIM/ICQ, IRC, Yahoo! и много других возможностей. Лицензия: [Apache 2](https://ru.wikipedia.org/wiki/%D0%9B%D0%B8%D1%86%D0%B5%D0%BD%D0%B7%D0%B8%D1%8F_Apache) , рейтинг - 676.
7.  [Netflix Exhibitor](https://github.com/Netflix/exhibitor) это система для ZooKeeper, обеспечивающая мониторинг, архивирование и восстановление, очистку и визуализацию. Лицензия: [Apache 2](https://ru.wikipedia.org/wiki/%D0%9B%D0%B8%D1%86%D0%B5%D0%BD%D0%B7%D0%B8%D1%8F_Apache) , рейтинг - 610.
8.  [Glyptodon Guacamole client](https://github.com/glyptodon/guacamole-client) - клиент, который позволяет работать с удаленным рабочим столом через браузер без установки какого-либо программного обеспечение. Использует HTML5, JavaScript и Java . Лицензия: [MIT](https://ru.wikipedia.org/wiki/%D0%9B%D0%B8%D1%86%D0%B5%D0%BD%D0%B7%D0%B8%D1%8F_MIT) , рейтинг - 556.
9.  [Bateman](https://github.com/fearofcode/bateman) - простая система торговли акциями, которая оптимизирует свои параметры, используя particle swarm оптимизацию. Лицензия: [MIT](https://ru.wikipedia.org/wiki/%D0%9B%D0%B8%D1%86%D0%B5%D0%BD%D0%B7%D0%B8%D1%8F_MIT) , рейтинг - 543.
10.  [Java repl](https://github.com/albertlatacz/java-repl) - реализация Read Eval Print Loop (простой интерактивной среды программирования, которая сразу вычисляет введенные пользователем выражения) для Java. Лицензия: [Apache 2](https://ru.wikipedia.org/wiki/%D0%9B%D0%B8%D1%86%D0%B5%D0%BD%D0%B7%D0%B8%D1%8F_Apache) , рейтинг - 536.
11.  [Seyren](https://github.com/scobal/seyren) это оболочка для управления предупреждениями (alert) для Graphite, поддерживает много каналов нотификации: Email, Flowdock, HipChat, HTTP, Hubot, IRCcat, PagerDuty, Pushover, SLF4J, Slack, SNMP, Twilio. Лицензия: [Apache 2](https://ru.wikipedia.org/wiki/%D0%9B%D0%B8%D1%86%D0%B5%D0%BD%D0%B7%D0%B8%D1%8F_Apache) , рейтинг - 527.
12.  [Graphhopper](https://github.com/graphhopper/graphhopper) это быстрая и эффективно использующий память программа определения лучшего дорожного маршрута на Java. По умолчанию использует данный OpenStreetMap, но существует импорт и из других источников. Лицензия: [Apache 2](https://ru.wikipedia.org/wiki/%D0%9B%D0%B8%D1%86%D0%B5%D0%BD%D0%B7%D0%B8%D1%8F_Apache) , рейтинг - 506.
13.  [Ttorrent](https://github.com/mpetazzoni/ttorrent) это Java реализация BitTorrent протокола, BitTorrent tracker и BitTorrent клиента . Лицензия: [Apache 2](https://ru.wikipedia.org/wiki/%D0%9B%D0%B8%D1%86%D0%B5%D0%BD%D0%B7%D0%B8%D1%8F_Apache) , рейтинг - 460.
...
3.  [MinecraftForge](https://github.com/MinecraftForge/MinecraftForge) Модификации для Minecraft . Лицензия: [GNU AGPLv2.1](http://www.gnu.org/licenses/old-licenses/lgpl-2.1.en.html), рейтинг - 981.
4.  [SpongePowered Sponge](https://github.com/SpongePowered/Sponge) Forge мод для Minecraft реализующий SpongeAPI. Лицензия: [MIT](https://ru.wikipedia.org/wiki/%D0%9B%D0%B8%D1%86%D0%B5%D0%BD%D0%B7%D0%B8%D1%8F_MIT) , рейтинг - 803.
5.  [BuildCraft](https://github.com/BuildCraft/BuildCraft) BuildCraft — расширение для Minecraft. Лицензия: [Apache 2](https://ru.wikipedia.org/wiki/%D0%9B%D0%B8%D1%86%D0%B5%D0%BD%D0%B7%D0%B8%D1%8F_Apache) , рейтинг - 799.
6.  [Equivalent Exchange 3](https://github.com/pahimar/Equivalent-Exchange-3) pahimar Equivalent-Exchange-3\. Моды для Minecraft. Лицензия: [Apache 2](https://ru.wikipedia.org/wiki/%D0%9B%D0%B8%D1%86%D0%B5%D0%BD%D0%B7%D0%B8%D1%8F_Apache) , рейтинг - 783.
7.  [SpongePowered SpongeAPI](https://github.com/SpongePowered/SpongeAPI) Minecraft плагин API. Лицензия: [Apache 2](https://ru.wikipedia.org/wiki/%D0%9B%D0%B8%D1%86%D0%B5%D0%BD%D0%B7%D0%B8%D1%8F_Apache) , рейтинг - 775.
8.  [WorldEdit](https://github.com/sk89q/WorldEdit) Редактор игровых карт для Minecraft. Лицензия: [GNU Lesser 3](https://en.wikipedia.org/wiki/GNU_Lesser_General_Public_License), рейтинг - 715.
9.  [Essentials](https://github.com/essentials/Essentials) Essentials - Minecraft серверный командный мод — добавлени более 100 команд для использования в игре . Лицензия: [GNU 3](https://en.wikipedia.org/wiki/GNU_General_Public_License), рейтинг - 423.
10.  [GlowstoneMC Glowstone](https://github.com/GlowstoneMC/Glowstone) Сервер для Bukkit Minecraft. Лицензия: [MIT](https://ru.wikipedia.org/wiki/%D0%9B%D0%B8%D1%86%D0%B5%D0%BD%D0%B7%D0%B8%D1%8F_MIT) , рейтинг - 421.
...
3.  [Javaee7 samples](https://github.com/javaee-samples/javaee7-samples) Примеры для Java EE 7 . Лицензия: [MIT](https://ru.wikipedia.org/wiki/%D0%9B%D0%B8%D1%86%D0%B5%D0%BD%D0%B7%D0%B8%D1%8F_MIT)/CDDL/GPLv2, рейтинг - 989.
4.  [Algorithms](https://github.com/pedrovgs/Algorithms) Решение для некоторых общих алгоритмических проблем, написанное на Java.. Лицензия: [Apache 2](https://ru.wikipedia.org/wiki/%D0%9B%D0%B8%D1%86%D0%B5%D0%BD%D0%B7%D0%B8%D1%8F_Apache) , рейтинг - 983.
5.  [WikiSort](https://github.com/BonzaiThePenguin/WikiSort) Быстрее и стабильные алгоритмы сортировки использующие O(1) памяти. Лицензия: [unlicense.org](http://unlicense.org), рейтинг - 953.
6.  [Spring projects Spring petclinic](https://github.com/spring-projects/spring-petclinic) Примеры Spring приложений . Лицензия: [Apache 2](https://ru.wikipedia.org/wiki/%D0%9B%D0%B8%D1%86%D0%B5%D0%BD%D0%B7%D0%B8%D1%8F_Apache) , рейтинг - 532.
7.  [Spring projects Spring integration samples](https://github.com/spring-projects/spring-integration-samples) Примеры кода и приложений Spring Integration. Лицензия: [Apache 2](https://ru.wikipedia.org/wiki/%D0%9B%D0%B8%D1%86%D0%B5%D0%BD%D0%B7%D0%B8%D1%8F_Apache) , рейтинг - 517.
8.  [Java algorithms implementation](https://github.com/phishman3579/java-algorithms-implementation) Коллекция алгоритмов и структур данных, написанных на Java. Лицензия: [Apache 2](https://ru.wikipedia.org/wiki/%D0%9B%D0%B8%D1%86%D0%B5%D0%BD%D0%B7%D0%B8%D1%8F_Apache) , рейтинг - 437.
9.  [Jboss developer Jboss eap quickstarts](https://github.com/jboss-developer/jboss-eap-quickstarts) Простые и рабочие примеры с простой демонстрацией JBoss EAP, Java EE 7 и других подобных технологий . Лицензия: [Apache 2](https://ru.wikipedia.org/wiki/%D0%9B%D0%B8%D1%86%D0%B5%D0%BD%D0%B7%D0%B8%D1%8F_Apache) , рейтинг - 434.
10.  [Databricks Learning spark](https://github.com/databricks/learning-spark) Примеры кода для книги Learning Spark. Лицензия: [MIT](https://ru.wikipedia.org/wiki/%D0%9B%D0%B8%D1%86%D0%B5%D0%BD%D0%B7%D0%B8%D1%8F_MIT) , рейтинг - 412.
