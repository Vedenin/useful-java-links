...
6.  [flyingsaucer](https://github.com/flyingsaucerproject/flyingsaucer) Flying Saucer это Java библиотека для использования XML или XHTML с использованием CSS 2.1 для генерации PDF, изображений или Swing panels.. Лицензия: [](https://en.wikipedia.org/wiki/GNU_General_Public_License)[GNU 2.1](https://en.wikipedia.org/wiki/GNU_General_Public_License), рейтинг github'а - 504.
